...
class Course(models.Model):
    ...
    duration = models.CharField(max_length=50, blank=True, help_text="e.g., 12 weeks, 2 months")
...
class Lesson(models.Model):
    ...
    content_file = models.FileField(upload_to=get_lesson_upload_path, blank=True, null=True)
